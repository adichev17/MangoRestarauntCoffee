...
builder.Services.AddHttpClient<ICouponRepository, CouponRepository>(u => u.BaseAddress = new Uri(configuration["ServiceUrls:CouponAPI"]));
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Mango.Services.ShoppingCardAPI", Version = "v1" });
    c.EnableAnnotations();
