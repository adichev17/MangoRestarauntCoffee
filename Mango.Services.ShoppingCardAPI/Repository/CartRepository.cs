...
namespace Mango.Services.ShoppingCardAPI.Repository
{
    public class CartRepository : ICartRepository
    {
        ...
        {
            var CartHeaderDromDb = await _db.CartHeaders.FirstOrDefaultAsync(u => u.UserId == userId);
            if (CartHeaderDromDb != null)
            {
                _db.CartDetails
                    .RemoveRange(_db.CartDetails.Where(u => u.CartHeaderId == CartHeaderDromDb.CartHeaderId));
                _db.CartHeaders.Remove(CartHeaderDromDb);
